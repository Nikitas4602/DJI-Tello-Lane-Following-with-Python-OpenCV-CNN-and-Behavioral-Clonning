# clean_auto_final.py — καθαρίζει ΣΥΓΚΕΚΡΙΜΕΝΟ session και φτιάχνει αυτόματα _final folder
...
# === ΕΔΩ ΒΑΖΕΙΣ ΤΟ SESSION ΠΟΥ ΘΕΣ ===
SRC_SESSION = Path(r"data\session_2025-10-15_09-25-22")  # μπορείς και "data/session_2025-10-14_13-54-28"
# =====================================
